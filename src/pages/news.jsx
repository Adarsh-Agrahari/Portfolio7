...
export default function News({ articles = [] }) {
	return (
		<div className={styles.newsContainer}>
			<Head>
				<title>Purushotham Reddy - News</title>
				<meta
					name="description"
					content="Stay updated with the latest news and insights from Purushotham Reddy on AI, business intelligence, and more."
				/>
				<meta
					name="keywords"
...
export async function getServerSideProps() {
	try {
		const articles = [
			{
				title: "AI Unlocked: Purushotham Reddy’s published guide to transforming fintech with AI and cloud computing",
